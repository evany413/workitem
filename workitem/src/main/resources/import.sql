...
INSERT INTO category_detail (PK_CATEGORY_DETAIL,fk_category,DESCRIPTION,create_date,update_date) VALUES (CATEGORY_DETAIL_SEQ.nextval,1,'休假事項',to_date('2018-10-01','yyyy-mm-dd'),to_date('2018-10-01','yyyy-mm-dd') ); 
INSERT INTO category_detail (PK_CATEGORY_DETAIL,fk_category,DESCRIPTION,create_date,update_date) VALUES (CATEGORY_DETAIL_SEQ.nextval,51,'無障礙網頁修改',to_date('2018-10-01','yyyy-mm-dd'),to_date('2018-10-01','yyyy-mm-dd') ); 
INSERT INTO category_detail (PK_CATEGORY_DETAIL,fk_category,DESCRIPTION,create_date,update_date) VALUES (CATEGORY_DETAIL_SEQ.nextval,51,'新版申訴系統介接',to_date('2018-10-02','yyyy-mm-dd'),to_date('2018-10-02','yyyy-mm-dd') ); 
INSERT INTO category_detail (PK_CATEGORY_DETAIL,fk_category,DESCRIPTION,create_date,update_date) VALUES (CATEGORY_DETAIL_SEQ.nextval,51,'新版申訴系統介接2',to_date('2018-10-02','yyyy-mm-dd'),to_date('2018-10-02','yyyy-mm-dd') ); 
